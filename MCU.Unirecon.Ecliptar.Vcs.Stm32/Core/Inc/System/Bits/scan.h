/*
 * ecliptar_sys_bit_scan.h
 *
 *  Created on: 31 mar 2021
 *      Author: merlin
 */

#ifndef _SYSTEM_BITS_SCAN_H_
#define _SYSTEM_BITS_SCAN_H_

#include "System/Bits/base.h"
#include "System/Bits/config.h"
