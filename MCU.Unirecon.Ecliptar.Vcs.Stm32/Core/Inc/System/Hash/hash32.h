/*
 * ecliptar_sys_hash32.h
 *
 *  Created on: 20 mar 2021
 *      Author: merlin
 */

#ifndef _SYSTEM_HASH_HASH32_H
#define _SYSTEM_HASH_HASH32_H

#include <inttypes.h> // for uint32_t and uint64_t
